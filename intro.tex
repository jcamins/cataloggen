...
cross-references interfiled. There is one idiosyncracy in this listing that needs
to be mentioned: due to the way the automated catalog generation system works,
cross-references for books with names that start similarly may not be correct (for
example, the cross-reference for the second A.B.A checklist will incorrectly point
to the first).
